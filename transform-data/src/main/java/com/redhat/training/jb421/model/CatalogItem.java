...
public class CatalogItem implements Serializable {
	...
	public String toString() {
		return "CatalogItem [id=" + id + ", sku=" + sku + ", title=" + title + ", price=" + price + ", description="
				+ description + ", author=" + author + ", imagePath=" + imagePath + ", category=" + category
				+ ", newItem=" + newItem + ", publisher=" + publisher + "]";
	}
